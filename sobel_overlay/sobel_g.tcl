...
################################################################
# This is a generated script based on design: zynq_system_design
#
...
# source zynq_system_design_script.tcl
...
set design_name zynq_system_design
...
ucdenver.pvt:user:buffer_size:1.0\
xilinx.com:ip:processing_system7:5.5\
xilinx.com:ip:proc_sys_reset:5.0\
ucdenver.pvt:user:sobel:1.1\
...
proc create_root_design { parentCell } {
  ...
  # Create instance: buffer_size_0, and set properties
  set buffer_size_0 [ create_bd_cell -type ip -vlnv ucdenver.pvt:user:buffer_size:1.0 buffer_size_0 ]
  ...
  set sobel_0 [ create_bd_cell -type ip -vlnv ucdenver.pvt:user:sobel:1.1 sobel_0 ]
  ...
  connect_bd_intf_net -intf_net axi_dma_0_M_AXIS_MM2S [get_bd_intf_pins axi_dma_0/M_AXIS_MM2S] [get_bd_intf_pins sobel_0/S00_AXIS]
...
HDL_ATTRIBUTE.DEBUG {true} \
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M01_AXI [get_bd_intf_pins buffer_size_0/S00_AXI] [get_bd_intf_pins ps7_0_axi_periph/M01_AXI]
  connect_bd_intf_net -intf_net sobel_0_M00_AXIS [get_bd_intf_pins axi_dma_0/S_AXIS_S2MM] [get_bd_intf_pins sobel_0/M00_AXIS]
connect_bd_intf_net -intf_net [get_bd_intf_nets sobel_0_M00_AXIS] [get_bd_intf_pins sobel_0/M00_AXIS] [get_bd_intf_pins system_ila_0/SLOT_0_AXIS]
  set_property -dict [ list \
HDL_ATTRIBUTE.DEBUG {true} \
 ] [get_bd_intf_nets sobel_0_M00_AXIS]

  # Create port connections
  connect_bd_net -net buffer_size_0_img_len [get_bd_pins buffer_size_0/img_len] [get_bd_pins sobel_0/CUSTOM_IMG_LEN] [get_bd_pins system_ila_0/probe1]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins axi_dma_0/m_axi_mm2s_aclk] [get_bd_pins axi_dma_0/m_axi_s2mm_aclk] [get_bd_pins axi_dma_0/s_axi_lite_aclk] [get_bd_pins axi_smc/aclk] [get_bd_pins buffer_size_0/s00_axi_aclk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins processing_system7_0/S_AXI_HP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/M01_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_0_100M/slowest_sync_clk] [get_bd_pins sobel_0/m00_axis_aclk] [get_bd_pins sobel_0/s00_axis_aclk] [get_bd_pins system_ila_0/clk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_100M/ext_reset_in]
  connect_bd_net -net rst_ps7_0_100M_interconnect_aresetn [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins rst_ps7_0_100M/interconnect_aresetn]
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins axi_dma_0/axi_resetn] [get_bd_pins axi_smc/aresetn] [get_bd_pins buffer_size_0/s00_axi_aresetn] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/M01_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_100M/peripheral_aresetn] [get_bd_pins sobel_0/m00_axis_aresetn] [get_bd_pins sobel_0/s00_axis_aresetn] [get_bd_pins system_ila_0/resetn]
  connect_bd_net -net sobel_0_ADDR_OUT [get_bd_pins sobel_0/ADDR_OUT] [get_bd_pins system_ila_0/probe0]
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x43C00000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs buffer_size_0/S00_AXI/S00_AXI_reg] SEG_buffer_size_0_S00_AXI_reg
