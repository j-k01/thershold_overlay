...
ucdenver.pvt:user:saturation_linkup:1.0\
ucdenver.pvt:user:sobel:1.0\
"
...
proc create_root_design { parentCell } {
  ...
  # Create instance: saturation_linkup_0, and set properties
  set saturation_linkup_0 [ create_bd_cell -type ip -vlnv ucdenver.pvt:user:saturation_linkup:1.0 saturation_linkup_0 ]

  # Create instance: sobel_0, and set properties
  set sobel_0 [ create_bd_cell -type ip -vlnv ucdenver.pvt:user:sobel:1.0 sobel_0 ]
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M01_AXI [get_bd_intf_pins ps7_0_axi_periph/M01_AXI] [get_bd_intf_pins saturation_linkup_0/S00_AXI]
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x43C00000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs saturation_linkup_0/S00_AXI/S00_AXI_reg] SEG_saturation_linkup_0_S00_AXI_reg
